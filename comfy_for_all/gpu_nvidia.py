...
class GPUIdleTimer:
    def __init__(
        self, gpu_index=0, idle_threshold=IDLE_TIMEOUT, start_time=None, last_time=None
    ):
        self.loaded = False
    ...
    try:
        while True:
            ...
            if gpu_timer.has_reached_idle_threshold():
                print(
                    f"GPU {gpu_timer.gpu_index} has been idle for {gpu_timer.idle_time:0.2f} seconds."
                )
